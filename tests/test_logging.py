...
import pytest
from luthien_control.logging import (
    DEFAULT_LOG_LEVEL,
    LOG_FORMAT,
    NOISY_LIBRARIES,
    setup_logging,
...
@patch("luthien_control.logging.Settings")
@patch("luthien_control.logging.logging.basicConfig")
@patch("luthien_control.logging.logging.getLogger")
def test_setup_logging_default_level(mock_get_logger: MagicMock, mock_basic_config: MagicMock, MockSettings: MagicMock):
    ...
    mock_get_logger.assert_any_call("luthien_control.logging")
    config_logger_mock = mock_get_logger("luthien_control.logging")
...
@patch("luthien_control.logging.logging.basicConfig")
@patch("luthien_control.logging.logging.getLogger")
@patch("luthien_control.logging.print")  # Mock print to check warning
