...
def create_mock_request_response(method="POST", url_path="/api/v1/chat", client_ip="192.168.1.1", host="test.example.com"):
...
async def test_log_db_entry_passes_correct_data(mock_log_req_resp, mock_get_pool):
    ...
    assert call_args['response_data']['headers'] == {"content-length": "100", "x-api-key": "test-key"}
